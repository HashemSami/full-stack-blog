...
import Header from "./src/components/header/Header.componnent";
import LoadingDotsIcon from "./src/components/loading-dot-icon/LodingDotIcon.component";
import MainPage from "./src/pages/MainPage.component";
